...
const communityNotes = [
  {
    title: "Quiet rain",
    text: "I wrote about coming home and letting music organize my thoughts.",
    author: "Victor",
    date: "18 May 2026",
    song: "Afterglow",
  ...
  {
    title: "Slow Sunday",
    text: "A slow day with coffee and a soft playlist to close the week.",
    author: "Yojan777",
    date: "16 May 2026",
    song: "Sunset Drive",
    artist: "Kali Uchis",
  ...
  {
    title: "Mental reset",
    text: "A short note to remind myself to breathe and play something calming.",
    author: "FerV24",
    date: "14 May 2026",
    song: "Open Window",
  ...
  },
  {
    ...
    text: "We shared notes from the night and AI prepared an emotional recap.",
    author: "Seebastiaaan",
    date: "12 May 2026",
  ...
  {
    title: "New beginning",
    text: "First day writing here. I liked how the music carried the story.",
    author: "Diana",
    date: "10 May 2026",
    song: "Bloom",
    artist: "Troye Sivan",
            ...
            <div className="mt-12 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] items-center">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="card-soft p-4">
                  ...
                  <p className="text-xs text-(--nb-ink-muted)">
                    AI finds songs that match your note.
                  </p>
                </div>
                <div className="card-soft p-4">
                  <p className="text-sm font-semibold">Shareable context</p>
                  <p className="text-xs text-(--nb-ink-muted)">
                    Highlights the key points so your note is easier to share.
                  </p>
                </div>
                <div className="card-soft p-4">
                  <p className="text-sm font-semibold">Smart memory</p>
                  <p className="text-xs text-(--nb-ink-muted)">
                    Finds similar notes in seconds with semantic search.
                  </p>
                </div>
              </div>
      ...
      <footer className="footer-dark border-t border-(--nb-stroke) bg-[#111827]">
        <div className="nb-container py-10">
          ...
          <div className="mt-10 flex flex-col gap-2 text-xs text-(--nb-ink-muted) sm:flex-row sm:items-center sm:justify-between">
            ...
            <span>Copyright 2026 NoteBeat. All rights reserved.</span>
          </div>
        </div>
      </footer>
    </div>
